...
<li class="${fn:escapeXml(productTagClasses)}">
	<ycommerce:testId code="test_searchPage_wholeProduct">
        ...
        <c:if test="${product.wrapAvailable}">
		<ycommerce:testId code="searchPage_productName_wrapAvailable_${product.wrapAvailable}">
        	<p><b>Wrap Available</b> ${ycommerce:sanitizeHTML(product.wrapAvailable)}</p>
        		</ycommerce:testId>
